...
% N X 1, where N is the number of feature dimension
...
%confidences = [features_pos; features_neg]*w + b;% this is predicted 
confidences  = X' * w + b;
label_vector = [ones(size(features_pos,1),1); -1*ones(size(features_neg,1),1)]; % this is the label
